            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    case '/login':
                        ...
                        if (!pwd) await env.bpb.put('pwd', 'panel');
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `No1 - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `No1 - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `No1 - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `No1 - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'No1 Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'No1 Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'No1 Frag - Best Fragment 😎';
...
const getWoWConfig = async (env, client) => {
    ...
    for (let i = 0; i < 2; i++) {
        ...
        xrayOutbound.tag = i === 1 ? 'No1-ir' : 'warp-out';    
        
        if (i === 1) {
            delete xrayOutbound.streamSettings;
        } else {
            xrayOutbound.streamSettings.sockopt.dialerProxy = 'No1-ir';
        }
        ...
        singboxOutbound.tag = i === 1 ? 'No1' : 'No1 on No1 🚀';    
        
        if (i === 1) {
            delete singboxOutbound.detour;
        } else {
            singboxOutbound.detour = 'No1';
        }

        singboxOutbounds.push(singboxOutbound);
    }

    wowConfigXray.remarks = 'PANEL - Warp on Warp 🚀';
    ...
    warpConfigXray.remarks = 'No1 - Warp';
    ...
    wowConfigSingbox.outbounds[0].outbounds = ['No1 on No1 🚀', 'No1'];
...
const renderHomePage = async (env, hostName, fragConfigs) => {
	...
	<head>
        ...
        <title>No1 Panel ${panelVersion}</title>
	...
	<body>
		<h1>No1 Panel <span style="font-size: smaller;">${panelVersion}</span> 💦</h1>
		<div class="form-container">
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/sub/${userID}#No1-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}#No1-Normal', false)">
					...
					<tr>
						...
						<td>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=singbox#No1-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/sub/${userID}?app=sfa#No1-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=sfa#No1-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/fragsub/${userID}#No1 Fragment', 'Fragment Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/fragsub/${userID}#No1 Fragment', true)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/wow/${userID}#No1-WoW', 'Warp on Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/wow/${userID}#No1-WoW', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="copyToClipboard('https://${hostName}/wow/${userID}?app=singbox#No1-WoW', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
            ...
            <div class="footer">
                ...
                <a class="link" href="https://github.com/Par123456/Panel/" target="_blank">Github</a>
